...
class BboxLoss(nn.Module):
    ...
    def forward(
        ...
        # Focal-EIoU: down-weight well-regressed boxes, focus training on low-IoU hard examples
        focal_weight = (1.0 - iou.detach()).pow(0.5)
        loss_iou = (focal_weight * (1.0 - iou) * weight).sum() / target_scores_sum
